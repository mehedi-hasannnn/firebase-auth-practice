...
const SignUp = () => {
    ...
    const handleSignUp = e =>{
        ...
        if(password.length < 6){
            setErrorMessage('Password should be at least six characters long');
            return;
        }
    ...
    return (
                ...
                <div className="card bg-base-100 mx-auto mt-8 p-4 text-center w-full max-w-sm shrink-0 shadow-2xl">
                <h2 className="text-3xl ml-4 font-bold">Sign Up now!</h2>
                    <form onSubmit={handleSignUp} className="card-body">
                        ...
                        <div className="form-control relative">
                            ...
                            <button onClick={()=>setShowPassword(!showPassword)} className='btn btn-xs absolute right-4 top-12'>{showPassword ? <FaEyeSlash /> : <FaEye /> }</button>
                            <label className="label">
